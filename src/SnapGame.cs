...
SwinGame.LoadFontNamed ("GameFont", "Chunk Five Print.otf", 12);
        }
...
Color.RoyalBlue, "GameFont", 0, 40);				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 350, 50);
			}
			else
			{
